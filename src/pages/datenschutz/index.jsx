          ...
          <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
            <div className="space-y-12">
                ...
                <div className="space-y-6">
                  ...
                  <div>
                    ...
                    <div className="p-4 bg-accent/5 border-l-4 border-accent rounded">
                      ...
                      <p className="text-sm font-body font-semibold text-primary uppercase">
              ...
              <div className="bg-surface rounded-lg p-6 lg:p-8 border border-border">
                ...
                <div>
                  <h3 className="text-lg font-heading font-medium text-primary mb-3">Strato Web Analytics</h3>
                  <p className="text-text-secondary font-body leading-relaxed mb-3">
